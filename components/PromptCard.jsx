    ...
    return (<div className="prompt_card">
        <div className="flex justify-between items-start gap-5">
            ...
            <div className="copy_btn" onClick={handleCopy}>
                <Image width={12} height={12} src={copied === post.prompt ? '/assets/icons/tick.svg' : '/assets/icons/copy.svg'}/>
            </div>
        </div>
        <p className="m-4 font-satoshi text-gray-700 text-sm">{post.prompt}</p>
